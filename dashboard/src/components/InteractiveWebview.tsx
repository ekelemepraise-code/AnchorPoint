...
export const InteractiveWebview = ({
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Webview panel */}
      <div
        className="relative aspect-video rounded-xl border border-slate-500 bg-slate-950 overflow-hidden"
        role="region"
      ...
      >
        <AnimatePresence mode="wait">
          ...
          {webviewState === 'idle' && (
            ...
            >
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-primary/10">
                <ShieldCheck size={32} className="text-primary-text" aria-hidden="true" />
              </div>
              <div>
              ...
              <button
                ...
                className="btn-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-text"
          ...
          {webviewState === 'loading' && (
            ...
            >
              <div className="h-10 w-10 animate-spin rounded-full border-4 border-slate-500 border-t-primary-text" aria-hidden="true" />
          ...
          {webviewState === 'active' && (
            ...
            >
              ...
              <div className="flex items-center gap-2 border-b border-slate-600 bg-slate-900 px-4 py-2">
              ...
              <div className="flex flex-1 flex-col items-center justify-center gap-4 p-6">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-lg border border-slate-500 px-4 py-2 text-sm text-slate-400 transition-all hover:border-rose-500 hover:text-rose-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500/50"
                  ...
                  <button
                    ...
                    className="btn-primary text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-text"
          ...
          {webviewState === 'approved' && (
            ...
            >
              ...
              <p className="text-sm text-slate-400">Continuing to next step...</p>
            </motion.div>
          )}
          ...
          {webviewState === 'rejected' && (
            ...
            >
              ...
              <button
                ...
                className="text-sm text-primary-text hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-text rounded"
              >
                Try again
              </button>
            </motion.div>
